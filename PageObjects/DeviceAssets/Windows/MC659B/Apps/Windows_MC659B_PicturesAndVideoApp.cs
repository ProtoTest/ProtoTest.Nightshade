...
namespace ProtoTest.Nightshade.PageObjects.DeviceAssets.Windows.MC659B.Apps
{
    public class Windows_MC659B_PicturesAndVideoApp : IPicturesAndVideoApp
    {
        ...
        {
            EggplantTestBase.Note("Setting app to Pictures mode.");
            ...
            {
                EggplantTestBase.Note("App is currently in Video mode.  Changing to pictures mode...");
                StillMenuOption.Click();
            }
            Thread.Sleep(1000);
            PictureModeIcon.WaitForPresent();
            EggplantTestBase.Note("App is now in Pictures mode.");
        }

        public void SetToVideoMode()
        {
            EggplantTestBase.Note("Setting app to Video mode.");
            startBar.MenuOption.Click();
            Thread.Sleep(1000);
            ...
            {
                EggplantTestBase.Note("App is currently in Pictures mode.  Changing to video mode...");
                VideoMenuOption.Click();
            }
            Thread.Sleep(1000);
            VideoModeIcon.WaitForPresent();
            EggplantTestBase.Note("App is now in Video mode.");
        }

        public IPicturesAndVideoApp VerifyElements()
        {
            EggplantTestBase.Note("Verifying Pictures & Video app elements.");
        ...
        {
            EggplantTestBase.Note("Confirming Pictures and Video app is configured correctly.");
            while (!MyPicturesDefaultState.IsPresent())
            {
                EggplantTestBase.Note("Previous picture file detected.  Deleting...");
            ...
            {
                EggplantTestBase.Note("Previous video file detected.  Deleting...");
            ...
            EggplantTestBase.Note("Previous video files deleted.");
            ...
            EggplantTestBase.Note("Previous picture files deleted.");
            return this;
        }
        ...
        public IPicturesAndVideoApp TakePicture()
        {
            ...
            EggplantTestBase.Note("Taking a picture using device camera.");
            //startBar.MenuOption.Click();
        ...
        public IPicturesAndVideoApp OpenTakenPicture()
        {
            ...
            EggplantTestBase.Note("Opening the picture taken with device camera.");
        ...
        {
            EggplantTestBase.Note("Deleting the picture taken with device camera.");
            PictureCapturedIcon.Press();
            var driver = new EggplantDriver();
            driver.Type("d");
        ...
        public IPicturesAndVideoApp RecordAVideo()
        {
            ...
            EggplantTestBase.Note("Recording a video with the device camera.");
            CameraIcon.DoubleClick();
            //startBar.MenuOption.Click();
            //CameraMenuOption.Click();
            SetToVideoMode();
        ...
        {
            EggplantTestBase.Note("Opening the video recorded with the device camera.");
        ...
        {
            EggplantTestBase.Note("Deleting the video recorded with the device camera.");
            VideoCapturedIcon.Press();
            Thread.Sleep(1000);
            var driver = new EggplantDriver();
            driver.Type("d");
        ...
        {
            EggplantTestBase.Note("Setting device theme to option #" +picNumber+ ".");
            ...
            if (Equals(picNumber,"01"))
            {
                ...
                EggplantTestBase.Note("Device theme set to option #" + picNumber + ".");
            }
            if (Equals(picNumber,"02"))
            {
        ...
        {
            EggplantTestBase.Note("Setting device theme to default.");
            notificationsBar.OpenNotificationsBarMenu();
            notificationsBar.PicturesAndVideoProgram.Click();
        ...
        {
            EggplantTestBase.Note("Exiting Pictures & Video app.");
